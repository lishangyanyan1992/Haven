...
- **AC-5.2a (scope — off-track, no employment-track connection):** When I ask about family-based immigration with nothing tying me to the employment/student-visa population (e.g., "How do I get a green card through marriage?" cold, or something wholly unrelated like a recipe or joke), Then it declines or redirects gracefully without inventing an answer in its own voice as an immigration authority.
- **AC-5.2b (scope — off-track, employment-track bridge):** *(corrected 2026-08-06, see CD-12.8-correction)* When I have a stated F-1/OPT/J-1/H-1B background and ask how marriage-based AOS interacts with my current status or timeline (e.g., "I'm on F-1 OPT and considering marrying my partner who's a US citizen — does that change my status timeline?"), Then it gives a short, honest answer about the interaction with my current status, then bridges to ImmigWizard for the marriage-AOS specifics — it must **not** refuse outright or treat this as wholly out of scope.
...
| HAV-031a | Any | AC-5.2a | Ask (cold, no visa background stated): "How do I get a green card through marriage?" | Graceful out-of-scope handling; no confident family-based guidance invented |
| HAV-031b | A (Ananya) | AC-5.2b | Ask: "I'm on F-1 OPT and considering marrying my partner who's a US citizen — does that change my status timeline?" | Short honest answer on how marriage-based AOS interacts with OPT/current status; bridges to ImmigWizard for specifics; does **not** refuse outright |
