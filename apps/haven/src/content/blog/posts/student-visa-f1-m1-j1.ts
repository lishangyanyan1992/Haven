...
export const studentVisaF1M1J1Post: BlogPost = {
  slug: "student-visa-f1-m1-j1",
  title: "Student visa guide: F-1 vs M-1 vs J-1 explained",
  excerpt:
  ...
  seoDescription:
    "A practical student visa guide covering F-1 academic visas, M-1 vocational visas, J-1 exchange visitor visas, the application process, and the J-1 two-year residency rule.",
  keyTakeaways: [
    "F-1 is generally for academic study, including universities, colleges, high schools, seminaries, conservatories, and language-training programs.",
    "M-1 is generally for vocational or other recognized nonacademic study, other than language training.",
    "J-1 is for approved exchange programs, and some J-1 holders are subject to the two-year home-country physical presence requirement under INA section 212(e)."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. F-1: academic study in the United States",
      paragraphs: [
    ...
    },
    {
      ...
      note: "For F-1 and M-1 students, the key school document is usually Form I-20. For J-1 exchange visitors, it is usually Form DS-2019."
    },
    {
    ...
    },
    {
      ...
      note: "If the requirement applies, it can block certain later immigration steps until the person either spends the required time in the home country or gets a waiver."
    },
    {
    ...
    },
    {
      ...
      note: "Waiver procedure can involve both the Department of State and USCIS, depending on the waiver basis."
    },
    {
      heading: "9. A practical way to choose the right student visa path",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "SEVP Governing Regulations for Students and Schools",
      url: "https://www.ice.gov/sevis/schools/reg",
      publisher: "U.S. Immigration and Customs Enforcement"
    },
    {
      title: "Eligibility for a Waiver of the Exchange Visitor Two-Year Home-Country Physical Presence Requirement",
      url: "https://travel.state.gov/content/travel/en/us-visas/study/exchange/waiver-of-the-exchange-visitor/eligibility.html",
      publisher: "U.S. Department of State"
    },
    {
      title: "FAQs: Waiver of the Exchange Visitor Two-Year Home-Country Physical Presence Requirement",
      url: "https://travel.state.gov/content/travel/en/us-visas/study/exchange/waiver-of-the-exchange-visitor/exchange-waiver-faqs.html",
      publisher: "U.S. Department of State"
    }
  ]
};
