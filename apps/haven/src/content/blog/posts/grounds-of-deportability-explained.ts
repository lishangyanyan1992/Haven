...
export const groundsOfDeportabilityExplainedPost: BlogPost = {
  slug: "grounds-of-deportability-explained",
  ...
  seoDescription:
    "A current 2026 guide to the grounds of deportability under INA 237, including inadmissibility at admission, status violations, criminal offenses, document fraud, security grounds, public charge, and unlawful voting.",
  keyTakeaways: [
    "Deportability is not just a mirror image of inadmissibility. INA 237 applies to people who were admitted to the United States and later become removable under specific grounds.",
    "Status violations are a major deportability issue and can include overstays, unauthorized employment, or failure to maintain the terms of a nonimmigrant status.",
    "Some deportability grounds overlap with inadmissibility, but others are distinct and have their own timing, proof, and relief consequences."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Deportability starts with admission",
      paragraphs: [
      ...
      note: "In practice, 'removable' is the broader umbrella term. A person in proceedings may be removable because of inadmissibility or because of deportability, depending on how they entered and what happened afterward."
    },
    {
      heading: "2. The main deportability categories under INA 237",
      paragraphs: [
    ...
    {
      heading: "3. Inadmissible at time of entry or adjustment is broader than it sounds",
      paragraphs: [
    ...
    {
      heading: "4. Status violations are a major deportability issue",
      paragraphs: [
    ...
    {
      heading: "5. Criminal grounds of deportability are not limited to one conviction",
      paragraphs: [
    ...
    {
      heading: "6. Failure to register and document fraud are separate deportability issues",
      paragraphs: [
      ...
      note: "False claims to U.S. citizenship also appear in the deportability structure and are treated with unusual severity. USCIS has specifically updated guidance in this area in recent years."
    },
    {
      heading: "7. Security-related grounds still matter after admission",
      paragraphs: [
        "Security and related grounds are not just about keeping people out. INA 237(a)(4) makes certain admitted noncitizens deportable if they fall within covered national-security, foreign-policy, terrorist-activity, or related categories.",
        "This includes some cross-reference grounds to INA 212(a)(3), but again, the analysis is not just a generic 'mirror image' of inadmissibility. The deportability subsection and the cross-reference both matter."
      ]
    },
    {
      heading: "8. Public-charge deportability is real, but very narrow",
      paragraphs: [
    ...
    {
      heading: "9. Unlawful voting is its own deportability ground",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Changing to a Nonimmigrant F or M Student Status",
    ...
    {
      title: "Chapter 4 - Status and Nonimmigrant Visa Violations",
      url: "https://www.uscis.gov/policy-manual/volume-7-part-b-chapter-4",
      publisher: "USCIS"
    },
    {
  ...
  faqs: [
    {
      question: "Are deportability grounds just the same as inadmissibility grounds?",
      answer:
    ...
    {
      question: "Can a student become removable for violating F-1 status?",
      answer:
    ...
    {
      question: "Does deportability for unlawful voting require a conviction?",
      answer:
    ...
    {
      question: "Is public charge a common deportation ground?",
      answer:
