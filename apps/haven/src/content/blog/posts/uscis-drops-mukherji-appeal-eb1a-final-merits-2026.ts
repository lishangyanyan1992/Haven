...
export const uscisDropsMukherjiAppealEb1a2026Post: BlogPost = {
  slug: "uscis-drops-mukherji-appeal-eb1a-final-merits-2026",
  title:
  ...
  seoTitle:
    "USCIS Withdraws Mukherji EB-1A Appeal: Final Merits Ruling Stands",
  seoDescription:
    "USCIS withdrew its Mukherji v. Miller appeal, leaving intact a ruling that the EB-1A final merits test violates the APA. What it means for petitioners.",
  keyTakeaways: [
    "USCIS voluntarily dismissed its Eighth Circuit appeal in Mukherji v. Miller, leaving intact a January 2026 ruling that the EB-1A 'final merits determination' was adopted unlawfully without APA notice-and-comment rulemaking.",
    "The withdrawal looks strategic, not like a policy concession. USCIS will likely keep applying the Kazarian two-step framework, but denied petitioners now have stronger arguments in federal court.",
    "EB-1A approval rates fell to 53.4% in Q4 FY2025, with practitioners reporting many denials concentrated at the Step Two final merits stage that Mukherji invalidated.",
    "DHS may attempt to codify the framework through formal rulemaking, but even a codified rule faces challenge under Loper Bright since the INA does not authorize a subjective second-step analysis.",
  ],
  sections: [
    {
    ...
    {
      heading: "The 'Final Merits' Test, Explained",
      paragraphs: [
    ...
    {
      heading: "The Statute Does Not Require 'Continuous' Top-of-Field Status",
      paragraphs: [
    ...
    {
      heading: "Why USCIS Withdrew — and Why It Matters",
      paragraphs: [
    ...
    },
    {
      ...
      note: "USCIS has not issued any guidance, policy update, or Policy Manual revision in response to Mukherji. The agency's internal adjudication procedures remain unchanged as of June 13, 2026.",
    },
  ],
  sources: [
    {
      ...
      url: "https://blog.cyrusmehta.com/2026/06/uscis-withdraws-appeal-in-mukherji-what-changes-and-what-does-not.html",
      publisher: "Cyrus D. Mehta & Partners PLLC",
    },
    {
      title: "Mukherji Appeal Dropped",
      url: "https://www.murthy.com/2026/06/11/mukherji-appeal-dropped/",
      publisher: "Murthy Law Firm",
    },
    {
      title:
        "District Court Rules USCIS Use of 'Final Merits Determination' in EB1(a) Petitions",
      url: "https://www.murthy.com/2026/01/29/district-court-rules-uscis-use-of-final-merits-determination-in-eb1a-petitions/",
      publisher: "Murthy Law Firm",
    },
    {
      title:
    ...
    },
    {
      ...
      url: "https://cohentuckerlaw.com/the-end-of-the-final-merits-trap-what-uscis-dropping-its-appeal-in-mukherji-means-for-your-eb-1a-visa/",
      publisher: "Cohen Tucker + Ades",
    },
    {
      title:
        "What the Mukherji v. Miller Decision Means for EB-1A Petitioners",
      url: "https://www.fraserpllc.com/news-insights/what-the-mukherji-v-miller-decision-means-for-eb-1a-petitioners",
      publisher: "Fraser Immigration Law PLLC",
    },
    {
      title: "Kazarian v. USCIS, 596 F.3d 1115 (9th Cir. 2010)",
      url: "https://cdn.ca9.uscourts.gov/datastore/opinions/2010/03/04/07-56774.pdf",
      publisher: "U.S. Court of Appeals for the Ninth Circuit",
    },
    {
      title: "Loper Bright Enterprises v. Raimondo, 603 U.S. 369 (2024)",
    ...
    {
      title: "8 CFR § 204.5 — Petitions for Immigrant Workers",
      url: "https://www.ecfr.gov/current/title-8/chapter-I/subchapter-B/part-204/subpart-A/section-204.5",
      publisher: "Electronic Code of Federal Regulations",
    },
    {
      title:
        "Federal Court Challenges USCIS's EB-1A Final Merits Denial: What It Means",
      url: "https://natlawreview.com/article/federal-court-challenges-usciss-eb-1a-final-merits-denial-what-it-means",
      publisher: "National Law Review",
    },
    {
      title: "New USCIS Data: EB-1A and EB-2 NIW Approval Rates Decline",
      url: "https://manifestlaw.com/blog/immigration/news/new-uscis-data-q3-2025-eb1a-eb2-niw-approval-rates-decline/",
      publisher: "Manifest Law",
    },
  ],
  faqs: [
    {
    ...
    {
      question: "What is the current EB-1A approval rate?",
      answer:
  ...
  relatedSlugs: [
    "eb2-niw-denial-rate-spike-fy2025",
    "federal-court-vacates-100000-h1b-fee-2026",
    "court-vacates-uscis-benefits-hold-39-countries",
  ],
};
