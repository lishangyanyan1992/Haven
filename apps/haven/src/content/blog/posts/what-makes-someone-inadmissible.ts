...
export const whatMakesSomeoneInadmissiblePost: BlogPost = {
  slug: "what-makes-someone-inadmissible",
  ...
  seoDescription:
    "A current 2026 guide to U.S. inadmissibility grounds under INA 212(a), including health, criminal, security, public charge, fraud, false claims to citizenship, prior removal, unlawful presence, and documentation problems.",
  keyTakeaways: [
    "Inadmissibility is separate from visa eligibility. Someone can fit a visa category and still be denied admission or a green card because of an inadmissibility ground.",
    "Current immigration law no longer usually talks about 'exclusion' in the old way. The key modern terms are inadmissibility, admission, and removability or deportability.",
    "Some inadmissibility grounds have exceptions or waivers, but they are highly category-specific. You cannot assume a waiver exists just because one exists for a different ground or visa type."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. The 10 main inadmissibility categories",
      paragraphs: [
      ...
      note: "The statutory list is not just a checklist for people applying abroad. Many of these grounds also affect adjustment of status cases inside the United States."
    },
    {
      heading: "2. Health-related grounds: the disease list has changed over time",
      paragraphs: [
        "Older summaries often list diseases that are no longer the current public-health list. In 2026, CDC explains that communicable diseases of public health significance currently include gonorrhea, infectious Hansen's disease, infectious syphilis, and active tuberculosis, along with certain quarantinable diseases designated by executive order and reportable public-health-emergency events under international health regulations.",
        "Health-related inadmissibility also includes certain physical or mental disorders with associated harmful behavior, drug abuse or drug addiction, and, for many immigrant and adjustment applicants, failure to satisfy the vaccination requirements documented through the immigration medical exam."
      ],
      bullets: [
        "Communicable diseases of public health significance",
        "Physical or mental disorder with associated harmful behavior",
        "Drug abuse or drug addiction",
        "Vaccination-related inadmissibility for covered immigrant and adjustment applicants"
      ]
    },
    {
      heading: "3. Criminal grounds: more than just 'moral turpitude'",
      paragraphs: [
      ...
      note: "Arrests alone do not always equal inadmissibility, but conduct, admissions, convictions, and records can all matter. The legal analysis depends on the exact statute, disposition, and immigration context."
    },
    {
      heading: "4. Security and related grounds",
      paragraphs: [
        "Security-related inadmissibility is still a major category in 2026. USCIS includes espionage, sabotage, unlawful activity, attempts to oppose or control the U.S. government by force or other unlawful means, terrorist activities, certain foreign-policy concerns, membership in totalitarian parties in specified circumstances, and participation in Nazi persecution, genocide, torture, or extrajudicial killing.",
        "These cases are often determined through classified or sensitive information channels that are not visible the way ordinary filing defects are, which makes them particularly hard to diagnose from the outside."
      ]
    },
    {
      heading: "5. Public charge: still real, but not for everyone",
      paragraphs: [
    ...
    {
      heading: "6. Illegal entry, fraud, misrepresentation, and false claims to citizenship",
      paragraphs: [
      ...
      note: "USCIS updated its false-claim-to-citizenship guidance in 2025, reinforcing how severe that ground can be for immigrant applicants."
    },
    {
      heading: "7. Documentation, prior removal, and unlawful presence bars",
      paragraphs: [
    ...
    {
      heading: "8. Employment and miscellaneous grounds that people overlook",
      paragraphs: [
    ...
    {
      heading: "9. Inadmissible does not always mean permanently impossible",
      paragraphs: [
  ...
  sources: [
    {
      title: "Volume 8 - Admissibility",
      url: "https://www.uscis.gov/policy-manual/volume-8",
      publisher: "USCIS"
    },
    {
      title: "Part B - Health-Related Grounds of Inadmissibility",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-b",
      publisher: "USCIS"
    },
    {
      title: "CDC's Role in Immigration",
      url: "https://www.cdc.gov/immigrant-refugee-health/about/cdc-role-in-immigration.html",
      publisher: "CDC"
    },
    {
      title: "Part D - Criminal and Related Grounds of Inadmissibility",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-d",
      publisher: "USCIS"
    },
    {
      title: "Part F - National Security and Related Grounds of Inadmissibility",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-f",
      publisher: "USCIS"
    },
    {
      title: "Part G - Public Charge Ground of Inadmissibility",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-g",
      publisher: "USCIS"
    },
    {
      title: "Chapter 2 - Definitions (Public Charge)",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-g-chapter-2",
      publisher: "USCIS"
    },
    {
      title: "Part I - Illegal Entrants and Other Immigration Violators",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-i",
      publisher: "USCIS"
    },
    {
      title: "Part J - Fraud and Willful Misrepresentation",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-j",
      publisher: "USCIS"
    },
    {
      title: "Part K - False Claim to U.S. Citizenship",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-k",
      publisher: "USCIS"
    },
    {
      title: "Part L - Documentation Requirements",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-l",
      publisher: "USCIS"
    },
    {
      title: "Part N - Aliens Previously Removed",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-n",
      publisher: "USCIS"
    },
    {
      title: "Part O - Aliens Unlawfully Present",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-o",
      publisher: "USCIS"
    },
    {
      title: "Part Q - Practicing Polygamists, International Child Abductors, Unlawful Voters, and Tax Evaders",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-q",
      publisher: "USCIS"
    },
    {
      title: "Ineligibilities and Waivers: Laws",
  ...
  faqs: [
    {
      question: "What is the difference between inadmissible and deportable?",
      answer:
    ...
    {
      question: "Does inadmissible mean someone can never get a visa or green card?",
      answer:
    ...
    {
      question: "Can a false claim to U.S. citizenship be worse than ordinary misrepresentation?",
      answer:
    ...
    {
      question: "Does public charge apply to everyone applying for immigration status?",
      answer:
  ...
  relatedSlugs: [
    "us-immigration-legal-framework",
