...
export const eb5InvestorGreenCardPost: BlogPost = {
  slug: "eb5-investor-green-card",
  ...
  seoDescription:
    "A practical guide to the EB-5 investor green card, including current investment amounts, targeted employment areas, regional centers, Forms I-526 and I-526E, conditional residence, and Form I-829.",
  keyTakeaways: [
    "EB-5 is the immigrant investor category, not a standard employer-sponsorship case.",
  ...
  sections: [
    ...
    {
      heading: "1. What the EB-5 investor category is",
      paragraphs: [
    ...
    {
      heading: "4. How job creation works",
      paragraphs: [
    ...
    {
      heading: "5. Standalone EB-5 vs regional center EB-5",
      paragraphs: [
    ...
    {
      heading: "6. The filing path: I-526 or I-526E first",
      paragraphs: [
    ...
    {
      heading: "7. EB-5 leads to conditional permanent residence first",
      paragraphs: [
    ...
    {
      heading: "8. Removing the conditions with Form I-829",
      paragraphs: [
    ...
    {
      heading: "10. A practical way to think about EB-5",
      paragraphs: [
  ...
  sources: [
    {
      title: "About the EB-5 Visa Classification",
    ...
    {
      title: "EB-5 Immigrant Investor Process",
      url: "https://www.uscis.gov/working-in-the-united-states/permanent-workers/employment-based-immigration-fifth-preference-eb-5/eb-5-immigrant-investor-process",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Green Card for Immigrant Investors",
      url: "https://www.uscis.gov/green-card/green-card-eligibility/green-card-for-immigrant-investors",
      publisher: "USCIS"
    },
    {
      title: "Form I-526, Immigrant Petition by Standalone Investor",
      url: "https://www.uscis.gov/i-526",
      publisher: "USCIS"
    },
    {
      title: "Form I-526E, Immigrant Petition by Regional Center Investor",
      url: "https://www.uscis.gov/i-526e",
      publisher: "USCIS"
    },
    {
      title: "Form I-829, Petition by Investor to Remove Conditions on Permanent Resident Status",
