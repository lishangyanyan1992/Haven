...
export const citizenshipIneligibilityPriorRemovalMiscInadmissibilityPost: BlogPost = {
  slug: "citizenship-ineligibility-prior-removal-misc-inadmissibility",
  ...
  seoDescription:
    "A current 2026 guide to INA 212(a)(8), (9), and (10): citizenship ineligibility, prior removal and unlawful presence bars, and miscellaneous inadmissibility grounds like polygamy, unlawful voting, child abduction, and tax-motivated renunciation.",
  keyTakeaways: [
    "The citizenship-ineligibility ground is much narrower than older explanations make it sound. In practice, it is largely tied to permanent ineligibility for citizenship and draft-evasion issues, not a broad catch-all for bad conduct.",
    "Prior removal and unlawful presence bars are separate from the miscellaneous grounds, and they often turn on timing, departure, and reentry facts rather than criminal conduct alone.",
    "Several examples people casually group together, such as smuggling, missing hearings, illegal entry, student-status abuse, and false citizenship claims, actually belong to different inadmissibility sections."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Citizenship ineligibility is a narrow inadmissibility ground",
      paragraphs: [
    ...
    {
      heading: "3. Unlawful presence is related, but separate from prior removal",
      paragraphs: [
        "People often lump unlawful presence together with prior deportation, but current USCIS policy treats them separately. Part O covers unlawful presence, including the 3-year and 10-year bars triggered when a person departs the United States after accruing the required period of unlawful presence and then seeks admission again during the statutory bar period.",
        "Part P separately addresses aliens present after a previous immigration violation, which is where some of the harsher reentry-after-removal or unlawful-presence scenarios live. That means one case can involve multiple overlapping inadmissibility grounds, but they should not be analyzed as one single bar."
      ],
      bullets: [
        "3-year and 10-year bars are tied to departure after unlawful presence",
        "Prior removal bars and unlawful-presence bars are not identical",
        "Some post-violation reentry scenarios can create even more severe consequences",
        "The exact sequence of entry, departure, removal, and reentry matters"
      ]
    },
    {
      heading: "4. Miscellaneous grounds: this is the real catch-all section",
      paragraphs: [
    ...
    {
      heading: "5. What the source material gets wrong about 'miscellaneous' grounds",
      paragraphs: [
    ...
    {
      heading: "6. International child abduction and unlawful voting are easy to underestimate",
      paragraphs: [
    ...
    {
      heading: "7. Tax-motivated renunciation is highly specialized but still real",
      paragraphs: [
  ...
  sources: [
    {
      title: "Part M - Citizenship Ineligibility",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-m",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Part P - Aliens Present After Previous Immigration Violation",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-p",
      publisher: "USCIS"
    },
    {
  ...
  faqs: [
    {
      question: "Is prior deportation the same as unlawful presence?",
      answer:
    ...
    {
      question: "Does the miscellaneous inadmissibility section include illegal entry and false citizenship claims?",
      answer:
    ...
    {
      question: "What does citizenship ineligibility usually mean in practice?",
      answer:
    ...
    {
      question: "Can someone with a prior removal ever return legally?",
      answer:
