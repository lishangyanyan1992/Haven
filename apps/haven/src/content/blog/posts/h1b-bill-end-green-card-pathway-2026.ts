...
export const h1bBillEndGreenCardPathway2026Post: BlogPost = {
  ...
  seoTitle:
    "American White-Collar Worker Jobs Act: H-1B Green Card Path at Risk",
  seoDescription:
    "New bill would end H-1B green card pathway, cut visa to 2 years, and set 75th-percentile wage floor. What attorneys and H-1B holders need to know in 2026.",
  keyTakeaways: [
  ...
  sections: [
    ...
    },
    {
      ...
      note: "Important: This bill has not been enacted and faces steep legislative obstacles. No current visa holders or pending applications are affected by its introduction.",
    },
    {
    ...
    },
    {
      ...
      note: "This bill has not passed and is widely considered unlikely to advance. No rule change is in effect. This analysis is for informational purposes and long-term planning only.",
    },
    {
      heading: "Context: H-1B Program Under Pressure",
      paragraphs: [
  ...
  sources: [
    ...
    },
    {
      ...
      url: "https://roy.house.gov/media/press-releases/rep-roy-introduces-legislation-end-h-1b-abuse-protect-american-tech-workers",
      publisher: "Office of Rep. Chip Roy",
    },
    {
      title:
        "American White-Collar Worker Jobs Act Explained",
      url: "https://americanbazaaronline.com/2026/06/05/american-white-collar-worker-jobs-act-explained-482223/",
      publisher: "American Bazaar",
    },
    {
      title:
        "DHS Changes Process for Awarding H-1B Work Visas to Better Protect American Workers",
      url: "https://www.uscis.gov/newsroom/news-releases/dhs-changes-process-for-awarding-h-1b-work-visas-to-better-protect-american-workers",
      publisher: "USCIS",
    },
    {
      title:
        "FY 2027 H-1B Initial Registration Selection Process Completed",
      url: "https://www.uscis.gov/newsroom/alerts/fy-2027-h-1b-initial-registration-selection-process-completed",
      publisher: "USCIS",
    },
    {
      title: "Rep. Crane Introduces Legislation to Pause and Reform the Broken H-1B Visa Process",
      url: "https://crane.house.gov/2026/04/22/rep-crane-introduces-legislation-to-pause-and-reform-the-broken-h-1b-visa-process/",
      publisher: "Office of Rep. Eli Crane",
    },
    {
      title: "Visa Bulletin for June 2026",
      url: "https://travel.state.gov/content/travel/en/legal/visa-law0/visa-bulletin/2026/visa-bulletin-for-june-2026.html",
      publisher: "U.S. Department of State",
    },
    {
      title:
        "US Bill Eyes Major H-1B Overhaul, Seeks to End Green Card Track",
      url: "https://www.outlookbusiness.com/economy-and-policy/us-bill-eyes-major-h-1b-overhaul-seeks-to-end-green-card-track",
      publisher: "Outlook Business",
    },
  ],
  faqs: [
    {
      question: "What is the American White-Collar Worker Jobs Act?",
      answer:
    ...
    {
      question: "Will this bill pass Congress?",
      answer:
    ...
    {
      question: "Does this bill affect EB-1 or EB-2 NIW self-petitioners?",
      answer:
    ...
    {
      question: "What should I do if I'm on an H-1B visa right now?",
      answer:
  ...
  relatedSlugs: [
    "h1b-wage-weighted-lottery-fy2027-results",
    "eb2-india-per-country-limit-exhausted-fy2026",
