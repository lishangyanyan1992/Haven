...
export const trump100000H1BFeeExplainedPost: BlogPost = {
  slug: "trump-100000-h1b-fee-explained",
  ...
  seoDescription:
    "A sourced explainer on Trump’s new $100,000 H-1B fee, including what USCIS says it covers, what it does not cover, and why the rollout created confusion.",
  keyTakeaways: [
    "The proclamation was announced on September 19, 2025 and took effect on September 21, 2025.",
    "USCIS says the fee applies only to certain new H-1B petitions for workers abroad, not current holders, renewals, or most change-of-status filings inside the United States.",
    "The fee is additive, meaning it sits on top of the already existing H-1B petition fees employers pay."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. What the administration announced",
      paragraphs: [
    ...
    {
      heading: "2. What USCIS says the $100,000 fee actually covers",
      paragraphs: [
      ...
      note: "This scope is narrower than the first-wave public reaction suggested."
    },
    {
      heading: "3. Why the rollout caused so much confusion",
      paragraphs: [
    ...
    {
      heading: "4. Why employers still care even if the fee is narrower",
      paragraphs: [
    ...
    {
      heading: "5. Why this matters for workers planning next steps",
      paragraphs: [
    ...
    {
      heading: "6. The practical bottom line",
      paragraphs: [
  ...
  sources: [
    {
      title: "White House says $100K H-1B visa fee won’t apply to existing holders as Trump move stirs anxiety",
      url: "https://apnews.com/article/h1b-visa-changes-trump-cbb0995814cf2c9a3c74a6dcf2b31d72",
      publisher: "Associated Press"
    },
    {
      title: "New H-1B Fee and Other Recent H-1B Developments",
      url: "https://www.congress.gov/crs-product/IN12617",
    ...
    {
      title: "H-1B FAQ",
      url: "https://www.whitehouse.gov/releases/2025/09/h-1b-faq/",
      publisher: "The White House"
    }
  ]
};
