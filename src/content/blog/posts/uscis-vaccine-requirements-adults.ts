...
export const uscisVaccineRequirementsAdultsPost: BlogPost = {
  slug: "uscis-vaccine-requirements-adults",
  title: "USCIS vaccine requirements for adults: which vaccines do you need for Form I-693?",
  excerpt:
  ...
  keyTakeaways: [
    ...
    "The screenshot you shared matches an older CDC age table, but the current official CDC civil-surgeon instructions are dated March 11, 2025.",
    "You usually do not need to finish every multi-dose series before the civil surgeon signs Form I-693. CDC says at least one age-appropriate dose is usually enough at the exam if you are not already up to date."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "2. What the current CDC table says for adults 18 to 59",
      paragraphs: [
    ...
    {
      heading: "3. Why adults 60 and older should not assume the same list applies",
      paragraphs: [
    ...
    {
      heading: "4. What counts as proof if you do not want to restart vaccines",
      paragraphs: [
    ...
    {
      heading: "5. Do you need all doses completed before the I-693 is signed?",
      paragraphs: [
      ...
      note: "That is why many applicants can move forward with Form I-693 even if a vaccine series will continue after the appointment."
    },
    {
      heading: "6. How to use the screenshot you shared the right way",
      paragraphs: [
    ...
    {
      heading: "7. The practical adult checklist before your medical exam",
      paragraphs: [
  ...
  sources: [
    {
      title: "Vaccination: Technical Instructions for Civil Surgeons",
      url: "https://www.cdc.gov/immigrant-refugee-health/hcp/civil-surgeons/vaccination.html",
      publisher: "CDC"
    },
    {
      title: "Table 1: Vaccine Requirements According to Applicant Age for Civil Surgeons",
      url: "https://www.cdc.gov/immigrant-refugee-health/media/pdfs/Vaccine-Requirements-According-to-Applicant-Age-civil-surgeons-p.pdf",
      publisher: "CDC"
    },
    {
      title: "Vaccination Requirements",
      url: "https://www.uscis.gov/tools/designated-civil-surgeons/vaccination-requirements",
      publisher: "USCIS"
    },
    {
      title: "Report of Immigration Medical Examination and Vaccination Record (Form I-693)",
      url: "https://www.uscis.gov/i-693",
      publisher: "USCIS"
    },
    {
      title: "USCIS Policy Manual, Volume 8, Part B, Chapter 9 - Vaccination Requirement",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-b-chapter-9",
      publisher: "USCIS"
    }
  ]
};
