...
export const shortTermUsVisasB1B2K1Post: BlogPost = {
  slug: "short-term-us-visas-b1-b2-k1",
  title: "Short-term U.S. visas explained: B-1, B-2, and K-1",
  excerpt:
  ...
  seoDescription:
    "A practical guide to short-term U.S. visa options, including B-1 business visitor visas, B-2 tourist visas, and the K-1 fiance visa process.",
  keyTakeaways: [
    "B-1 is generally for temporary business activities like consulting, attending conferences, settling an estate, or negotiating contracts.",
    "B-2 is generally for tourism, visiting friends or relatives, medical treatment, and similar short personal trips.",
    "K-1 is different from a standard visitor visa. It is for the foreign-citizen fiance of a U.S. citizen, and the couple must marry within 90 days after entry."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. B-1: short-term travel for business",
      paragraphs: [
      ...
      note: "A B-1 visa does not authorize ordinary employment in the United States."
    },
    {
      heading: "2. B-2: short-term travel for tourism or personal reasons",
      paragraphs: [
    ...
    {
      heading: "4. K-1: not a tourist visa, but a short-term path to marry a U.S. citizen",
      paragraphs: [
    ...
    {
      heading: "7. Which short-term path fits your situation?",
      paragraphs: [
