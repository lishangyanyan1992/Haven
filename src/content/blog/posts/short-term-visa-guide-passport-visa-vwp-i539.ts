...
export const shortTermVisaGuidePassportVisaVwpI539Post: BlogPost = {
  slug: "short-term-visa-guide-passport-visa-vwp-i539",
  title: "Short-term visa guide: passport, visa, Visa Waiver Program, and Form I-539",
  excerpt:
  ...
  seoDescription:
    "A practical short-term U.S. visa guide covering passports, visas, the Visa Waiver Program, ESTA, extending stay, and changing status with Form I-539.",
  keyTakeaways: [
    "In most cases, a passport is your travel document and the visa is the U.S. government’s permission mechanism for a specific temporary purpose.",
    "Some travelers do not need a visa for short business or tourism trips if they qualify for the Visa Waiver Program and have ESTA approval.",
    "If you want to extend your stay or change to another nonimmigrant status, Form I-539 may be the right tool, but you usually must file before your current authorized stay expires."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "4. The big trap: people confuse short entry with flexible status",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Application to Extend/Change Nonimmigrant Status (Form I-539)",
