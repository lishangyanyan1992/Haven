...
export const humanitarianVisasSTUVPost: BlogPost = {
  slug: "humanitarian-visas-s-t-u-v",
  title: "Humanitarian visas explained: S, T, U, and the limited V visa",
  excerpt:
  ...
  seoDescription:
    "A practical guide to humanitarian visa options in the United States, including S visas for informants and witnesses, T visas for trafficking survivors, U visas for victims of qualifying crimes, and why the V visa is very limited today.",
  keyTakeaways: [
    "S, T, and U visas are very different categories, even though all three can involve cooperation with law enforcement or protection for vulnerable people.",
    "T visas are for certain survivors of severe trafficking, while U visas are for victims of qualifying criminal activity who suffered substantial abuse and are helpful to law enforcement.",
    "The V visa still exists in the law, but it is a narrow category tied to old family petitions filed on or before December 21, 2000."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. S visa: for certain witnesses and informants",
      paragraphs: [
    ...
    },
    {
      ...
      note: "T status can also open a path to employment authorization, benefits in some cases, and later adjustment to permanent residence if the legal requirements are met."
    },
    {
      heading: "3. U visa: for victims of qualifying crimes",
      paragraphs: [
    ...
    {
      heading: "4. T visa vs U visa: the practical difference",
      paragraphs: [
  ...
  sources: [
    {
      title: "Inter-Agency Alien Witness and Informant Record (Form I-854)",
      url: "https://www.uscis.gov/i-854",
      publisher: "USCIS"
    },
    {
      title: "Green Card for an Informant (S Nonimmigrant)",
      url: "https://www.uscis.gov/green-card/green-card-eligibility/green-card-for-an-informant-s-nonimmigrant",
      publisher: "USCIS"
    },
    {
      title: "Victims of Human Trafficking: T Nonimmigrant Status",
      url: "https://www.uscis.gov/humanitarian/victims-of-human-trafficking-t-nonimmigrant-status",
      publisher: "USCIS"
    },
    {
      title: "Application for T Nonimmigrant Status (Form I-914)",
      url: "https://www.uscis.gov/i-914",
      publisher: "USCIS"
    },
    {
      title: "Victims of Criminal Activity: U Nonimmigrant Status",
      url: "https://www.uscis.gov/humanitarian/victims-of-criminal-activity-u-nonimmigrant-status",
      publisher: "USCIS"
    },
    {
      title: "Petition for U Nonimmigrant Status (Form I-918)",
      url: "https://www.uscis.gov/i-918",
      publisher: "USCIS"
    },
    {
      title: "V Nonimmigrant Visas",
      url: "https://www.uscis.gov/family/family-of-green-card-holders-permanent-residents/v-nonimmigrant-visas",
      publisher: "USCIS"
    }
  ]
};
