...
export const cancellationOfRemovalExplainedPost: BlogPost = {
  slug: "cancellation-of-removal-explained",
  ...
  seoDescription:
    "A current 2026 guide to cancellation of removal, including eligibility for lawful permanent residents, nonpermanent residents, the stop-time rule, continuous residence, continuous physical presence, good moral character, hardship, and special-rule cancellation.",
  keyTakeaways: [
    "Cancellation of removal is a form of relief in immigration court, not just a generic waiver that forgives removability.",
    "There are different cancellation tracks for lawful permanent residents, nonpermanent residents, and certain survivors of abuse.",
    "The stop-time rule, criminal bars, and the hardship standard are often the hardest parts of a cancellation case."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Cancellation of removal for lawful permanent residents",
      paragraphs: [
    ...
    {
      heading: "2. The stop-time rule matters for LPR cancellation",
      paragraphs: [
    ...
    {
      heading: "3. Cancellation of removal for nonpermanent residents",
      paragraphs: [
    ...
    {
      heading: "4. Continuous physical presence is not the same as continuous residence",
      paragraphs: [
      ...
      note: "Continuous physical presence is stricter than the continuous-residence idea used in the LPR track."
    },
    {
      heading: "5. Good moral character is its own legal inquiry",
      paragraphs: [
    ...
    {
      heading: "6. The hardship standard is intentionally very high",
      paragraphs: [
    ...
    {
      heading: "7. Special-rule cancellation for survivors of abuse is a separate track",
      paragraphs: [
    ...
    {
      heading: "8. What forms are used in immigration court",
      paragraphs: [
  ...
  sources: [
    {
      title: "Explore Relief Options",
      url: "https://www.justice.gov/eoir/explore-relief-options",
      publisher: "EOIR"
    },
    {
      title: "Cancellation of Removal for Permanent Residents",
      url: "https://www.justice.gov/eoir/cancellation-removal-permanent-residents",
      publisher: "EOIR"
    },
    {
      title: "Cancellation of Removal for Nonpermanent Residents",
      url: "https://www.justice.gov/eoir/cancellation-removal-nonpermanent-residents",
      publisher: "EOIR"
    },
    {
      title: "Special Rule Cancellation of Removal",
      url: "https://www.justice.gov/eoir/special-rule-cancellation-removal",
      publisher: "EOIR"
    },
    {
      title: "Application for Cancellation of Removal for Certain Permanent Residents",
      url: "https://www.justice.gov/doj/resource/application-cancellation-removal-certain-permanent-residents",
      publisher: "EOIR"
    },
    {
      title: "Application for Cancellation of Removal and Adjustment of Status for Certain Nonpermanent Residents",
      url: "https://www.justice.gov/doj/resource/application-cancellation-removal-and-adjustment-status-certain-nonpermanent-residents",
      publisher: "EOIR"
    }
  ],
  faqs: [
    {
      question: "Is cancellation of removal the same as a waiver of inadmissibility?",
      answer:
    ...
    {
      question: "Can a green card holder apply for cancellation of removal?",
      answer:
    ...
    {
      question: "What is the hardship standard for nonpermanent resident cancellation?",
      answer:
    ...
    {
      question: "Does the 10-year physical-presence clock keep running until the hearing date?",
      answer:
  ...
  relatedSlugs: [
    ...
    "security-public-charge-unlawful-voting-deportability",
