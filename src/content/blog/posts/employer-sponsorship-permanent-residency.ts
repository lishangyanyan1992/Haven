...
export const employerSponsorshipPermanentResidencyPost: BlogPost = {
  slug: "employer-sponsorship-permanent-residency",
  title: "Employer sponsorship for permanent residency: how employment-based green cards work",
  excerpt:
  ...
  seoDescription:
    "A practical guide to employer sponsorship for permanent residency, including EB-1, EB-2, EB-3, labor certification, Form I-140, national interest waivers, and how employment-based green cards work.",
  keyTakeaways: [
    "Employment-based permanent residency is organized into preference categories, commonly called EB-1 through EB-5.",
  ...
  sections: [
    ...
    {
      heading: "1. What employer sponsorship for permanent residency usually means",
      paragraphs: [
        "When people say an employer is sponsoring them for a green card, they usually mean the employer is acting as the petitioner in an employment-based immigrant case. In many categories, the employer takes the lead by offering the permanent job, handling the labor-market process if required, and filing the immigrant petition.",
        "USCIS uses Form I-140, Immigrant Petition for Alien Worker, for many of these employment-based permanent residence paths. That petition is a core filing in EB-1, EB-2, and EB-3 cases."
      ]
    },
    {
      ...
      bullets: [
        ...
        "EB-5: immigrant investors who make a qualifying investment and create jobs"
      ]
    },
    {
      ...
      bullets: [
        "EB-1A: extraordinary ability and possible self-petition",
        "EB-1B: outstanding professors and researchers with employer sponsorship",
        "EB-1C: certain multinational managers and executives with employer sponsorship"
      ]
    },
    {
    ...
    },
    {
      ...
      bullets: [
        "Skilled worker: at least two years of training or experience",
        "Professional: at least a bachelor’s degree or equivalent and a job that requires it",
        "Other worker: less than two years of training or experience, but not temporary or seasonal"
      ]
    },
    {
    ...
    {
      heading: "10. A practical way to analyze an employer-sponsored green card case",
      paragraphs: [
        "If you are evaluating an employment-based green card path, the first questions are usually straightforward.",
        "What EB category fits the job and the worker? Does the case require PERM labor certification? Who is filing the I-140? And is the person using a category that allows self-petition instead of standard employer sponsorship?"
      ],
      bullets: [
        "Identify the right EB category",
        "Check whether labor certification is required",
        "Confirm whether the employer or the worker files the I-140",
        "Check visa availability and priority-date issues if the category is backlogged"
      ]
    },
    {
  ...
  sources: [
    ...
    {
      title: "I-140, Immigrant Petition for Alien Worker",
    ...
    {
      title: "Employment-Based Immigration: Third Preference EB-3",
    ...
    },
    {
      ...
      url: "https://www.dol.gov/agencies/eta/foreign-labor?lang=en",
      publisher: "U.S. Department of Labor"
    },
    {
      title: "Employment-Based Immigration: Fourth Preference EB-4",
    ...
    {
      title: "Employment-Based Immigration Fifth Preference EB-5",
