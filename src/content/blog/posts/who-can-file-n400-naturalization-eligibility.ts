...
export const whoCanFileN400NaturalizationEligibilityPost: BlogPost = {
  slug: "who-can-file-n400-naturalization-eligibility",
  ...
  seoTitle: "Who can file Form N-400 in 2026? Naturalization eligibility explained",
  seoDescription:
    "A current 2026 guide to who can file Form N-400, including the 5-year rule, 3-year marriage-based rule, military naturalization, continuous residence, physical presence, N-470 exceptions, biometrics, and when to use N-600 instead.",
  keyTakeaways: [
    "Do not file Form N-400 if you are already a U.S. citizen through birth in the United States or through your parents.",
    "Most applicants naturalize under the 5-year green-card rule, while some spouses of U.S. citizens qualify under a 3-year rule and some military applicants qualify under special provisions.",
    "Naturalization eligibility depends on more than just time as a green card holder. Continuous residence, physical presence, good moral character, and the interview and test rules all matter."
  ],
  faqs: [
    {
      question: "Should I file Form N-400 if one of my parents is a U.S. citizen?",
      answer:
    ...
    {
      question: "Can I apply for naturalization after 3 years instead of 5?",
      answer:
    ...
    {
      question: "Do I mail fingerprints and passport photos with Form N-400?",
      answer:
    ...
    {
      question: "Does military service remove the 5-year waiting period?",
      answer:
  ...
  sections: [
    ...
    {
      heading: "1. First, make sure you are not already a U.S. citizen",
      paragraphs: [
      ...
      note: "Being unsure about citizenship through parents is a strong reason to check the citizenship-through-parents rules before filing a naturalization case."
    },
    {
      heading: "2. The standard 5-year naturalization track",
      paragraphs: [
    ...
    {
      heading: "3. The 3-year rule for some spouses of U.S. citizens",
      paragraphs: [
      ...
      note: "This is why the 3-year path is not available in every case where the original green card was marriage-based."
    },
    {
      heading: "4. Military naturalization follows different rules",
      paragraphs: [
    ...
    {
      heading: "5. Continuous residence and physical presence are separate requirements",
      paragraphs: [
    ...
    {
      heading: "6. Overseas work exceptions exist, but they are narrow",
      paragraphs: [
      ...
      note: "A spouse applying under INA 319(b) because a U.S. citizen spouse is stationed abroad under qualifying employment is a different rule and generally does not require Form N-470."
    },
    {
      heading: "7. Form N-400 is more than a biodata form",
      paragraphs: [
    ...
    {
      heading: "8. Biometrics and photos in 2026",
      paragraphs: [
    ...
    {
      heading: "9. The interview and civics test changed recently",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "I am a Lawful Permanent Resident of 5 Years",
      url: "https://www.uscis.gov/citizenship/learn-about-citizenship/citizenship-and-naturalization/i-am-a-lawful-permanent-resident-of-5-years",
      publisher: "USCIS"
    },
    {
      title: "I am Married to a U.S. Citizen",
      url: "https://www.uscis.gov/citizenship/learn-about-citizenship/citizenship-and-naturalization/i-am-married-to-a-us-citizen",
      publisher: "USCIS"
    },
    {
      title: "Naturalization Through Military Service",
      url: "https://www.uscis.gov/military/naturalization-through-military-service",
      publisher: "USCIS"
    },
    {
      title: "Continuous Residence and Physical Presence Requirements for Naturalization",
      url: "https://www.uscis.gov/citizenship/continuous-residence-and-physical-presence-requirements-for-naturalization",
      publisher: "USCIS"
    },
    {
      title: "Application to Preserve Residence for Naturalization Purposes (Form N-470)",
      url: "https://www.uscis.gov/n-470",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Application for Certificate of Citizenship (Form N-600)",
