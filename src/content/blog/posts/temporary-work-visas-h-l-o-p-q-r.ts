...
export const temporaryWorkVisasHLOPQRPost: BlogPost = {
  slug: "temporary-work-visas-h-l-o-p-q-r",
  title: "Temporary work visas explained: H, L, O, P, Q, and R",
  excerpt:
  ...
  seoDescription:
    "A practical guide to temporary U.S. work visas, including H-1B, H-2A, H-2B, H-3, L-1, O-1, P visas, Q-1, and R-1.",
  keyTakeaways: [
    "Most temporary work visas require a U.S. employer or other petitioner to file Form I-129 before the worker applies for a visa or admission.",
    "H visas cover several very different temporary categories, including specialty occupations, agricultural work, nonagricultural seasonal work, and certain training programs.",
    "L, O, P, Q, and R classifications are all temporary too, but each is built for a different purpose such as intracompany transfer, extraordinary ability, performance, cultural exchange, or religious work."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. The most important starting point: purpose drives the visa category",
      paragraphs: [
    ...
    {
      heading: "2. H visas cover several different kinds of temporary work",
      paragraphs: [
    ...
    {
      heading: "11. A practical framework for choosing the right temporary work visa",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Petition for a Nonimmigrant Worker (Form I-129)",
    ...
    {
      title: "Nonimmigrant Petition Based on Blanket L Petition (Form I-129S)",
