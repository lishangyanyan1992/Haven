...
export const h1bGracePeriodChecklistPost: BlogPost = {
  slug: "h1b-grace-period-checklist",
  ...
  keyTakeaways: [
    "Confirm the exact last day on payroll before you assume your timeline.",
    "Use the first few days to gather documents and map options, not to submit rushed applications.",
    "Track transfer, change-of-status, and departure decisions against real deadlines."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Get the date right before you build a plan",
      paragraphs: [
    ...
    {
      heading: "2. Gather the documents that every option will ask for",
      paragraphs: [
    ...
    {
      heading: "3. Keep multiple paths open for one week",
      paragraphs: [
      ...
      note: "A calm backup plan lowers pressure and usually leads to better decisions."
    },
    {
      heading: "4. Communicate in a way that speeds up useful help",
      paragraphs: [
