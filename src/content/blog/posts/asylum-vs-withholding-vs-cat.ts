...
export const asylumVsWithholdingVsCatPost: BlogPost = {
  slug: "asylum-vs-withholding-vs-cat",
  ...
  seoDescription:
    "A current 2026 guide to asylum vs withholding of removal vs CAT protection, including burden of proof, one-year filing rule, bars, family benefits, green card consequences, and what happens in withholding-only proceedings.",
  keyTakeaways: [
    "Asylum is the strongest of the three for long-term immigration status because it can lead to a green card and can include derivative benefits for qualifying spouse and children.",
    "Withholding of removal has a higher burden of proof than asylum and only blocks return to a specific country. It does not create derivative status or a direct path to permanent residence.",
    "CAT protection is about the risk of torture, not protected-ground persecution. In some barred cases, the result may be CAT deferral of removal rather than asylum or withholding."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Asylum: lower burden, broader benefits, discretionary relief",
      paragraphs: [
    ...
    {
      heading: "2. Withholding of removal: higher burden, narrower protection",
      paragraphs: [
      ...
      note: "EOIR states that someone granted withholding may still be removed to a third country where their life or freedom would not be threatened."
    },
    {
      heading: "3. CAT protection: torture-based, not protected-ground-based",
      paragraphs: [
    ...
    {
      heading: "4. CAT withholding vs CAT deferral",
      paragraphs: [
    ...
    {
      heading: "5. Bars and deadlines: where asylum is most vulnerable",
      paragraphs: [
    ...
    {
      heading: "6. Family benefits and long-term status are not the same",
      paragraphs: [
    ...
    {
      heading: "7. Where these claims are decided",
      paragraphs: [
    ...
    {
      heading: "8. Which standard is hardest to satisfy",
      paragraphs: [
  ...
  sources: [
    {
      title: "Asylum, Withholding of Removal, Convention Against Torture",
      url: "https://www.justice.gov/eoir/asylum-withholding-removal-convention-against-torture",
      publisher: "EOIR"
    },
    {
  ...
  faqs: [
    {
      question: "Is withholding of removal the same as asylum?",
      answer:
    ...
    {
      question: "Can you win CAT even if you lose asylum?",
      answer:
    ...
    {
      question: "What is CAT deferral of removal?",
      answer:
    ...
    {
      question: "Do withholding of removal or CAT lead to a green card?",
      answer:
