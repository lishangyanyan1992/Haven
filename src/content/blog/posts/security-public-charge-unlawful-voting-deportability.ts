...
export const securityPublicChargeUnlawfulVotingDeportabilityPost: BlogPost = {
  slug: "security-public-charge-unlawful-voting-deportability",
  ...
  seoDescription:
    "A current 2026 guide to three lesser-understood grounds of deportability under INA 237: security-related grounds, the narrow public-charge deportability rule, and unlawful voting or false claims to U.S. citizenship.",
  keyTakeaways: [
    "Security-related deportability under INA 237(a)(4) can apply after admission and is not limited to ordinary criminal convictions.",
    "Public-charge deportability is much narrower than public-charge inadmissibility and has historically been rare.",
    "Unlawful voting and false claims to U.S. citizenship can create deportability even without a criminal conviction."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Security-related deportability applies after admission",
      paragraphs: [
        "INA 237(a)(4) covers security and related grounds of deportability. The lecture is directionally right that this includes conduct related to espionage, sabotage, terrorist activity, or efforts to oppose or control the U.S. government by force, violence, or other unlawful means.",
        "But the current framework is more precise than a general warning about security concerns. The deportability ground cross-references some of the national-security concepts found in INA 212(a)(3), and it applies to admitted noncitizens who fall within the covered categories after admission."
      ],
      bullets: [
        "Espionage or sabotage-related conduct can matter",
        "Certain terrorist-activity grounds can trigger deportability",
        "Certain foreign-policy and national-security-related grounds can apply",
        "Opposition to or attempted control of the U.S. government by force or unlawful means can create removability"
      ],
      note: "This is one of the clearest examples of why deportability is not just about ordinary criminal court outcomes. A person can face removability under national-security grounds even when the immigration analysis does not track a simple state-court conviction model."
    },
    {
      heading: "2. Public-charge deportability is real, but the legal test is extremely narrow",
      paragraphs: [
        "The lecture correctly warns that public-charge deportability is rare and complicated. Current USCIS guidance says the standards for public-charge deportability are narrow and that charges of deportability on this basis have historically been rare.",
        "The statute does not say that anyone who receives public benefits becomes deportable. That is the biggest misconception. USCIS explains that a person is deportable as a public charge only if they become a public charge within five years after entry from causes not affirmatively shown to have arisen since entry, and a separate set of repayment and collection conditions is also satisfied."
      ]
    },
    {
      heading: "3. The public-charge 'ands' mostly still describe the rule correctly",
      paragraphs: [
      ...
      note: "The mere receipt of benefits within five years of entry does not make a person deportable as a public charge."
    },
    {
      heading: "4. Why the lecture’s disability and post-entry examples matter",
      paragraphs: [
    ...
    {
      heading: "5. Public-charge deportability is different from public-charge inadmissibility",
      paragraphs: [
    ...
    {
      heading: "6. Unlawful voting is a separate deportability ground",
      paragraphs: [
    ...
    {
      heading: "7. False claims to U.S. citizenship often travel with unlawful-voting cases",
      paragraphs: [
      ...
      note: "USCIS specifically says an alien may be removable based on a false claim to U.S. citizenship made in an oral interview, a written or online application, or by submitting evidence."
    },
    {
  ...
  sources: [
    {
      title: "Learn About the Immigration Court",
      url: "https://www.justice.gov/eoir/learn-about-immigration-court",
      publisher: "EOIR"
    },
    {
      title: "Ground of Deportability",
      url: "https://www.justice.gov/sites/default/files/eoir/legacy/2014/08/15/deportability.pdf",
      publisher: "EOIR"
    },
    {
      title: "Public Charge Resources",
      url: "https://www.uscis.gov/archive/public-charge-resources",
      publisher: "USCIS"
    },
    {
      title: "Conditional Bars for Acts in Statutory Period",
      url: "https://www.uscis.gov/node/73883",
      publisher: "USCIS"
    },
    {
      title: "USCIS Updates Policy on False Claims of U.S. Citizenship",
  ...
  faqs: [
    {
      question: "Does receiving public benefits automatically make someone deportable?",
      answer:
    ...
    {
      question: "Can someone be deportable for unlawful voting without a conviction?",
      answer:
    ...
    {
      question: "Are security-related deportability grounds just ordinary criminal grounds?",
      answer:
    ...
    {
      question: "Is public-charge deportability the same as public-charge inadmissibility?",
      answer:
  ...
  relatedSlugs: [
    "grounds-of-deportability-explained",
