...
export const selfPetitionOptionsPermanentResidencyAbusePost: BlogPost = {
  slug: "self-petition-options-permanent-residency-abuse",
  title: "Self-petition options for permanent residency when abuse is involved",
  excerpt:
  ...
  seoDescription:
    "A practical guide to self-petition options for permanent residency when abuse is involved, including VAWA eligibility, Form I-360, who may qualify, and what family relationships do not fit the rule.",
  keyTakeaways: [
    "VAWA allows certain people in abusive qualifying family relationships to self-petition for a green card path instead of depending on the abuser to file.",
  ...
  sections: [
    ...
    {
      heading: "1. What self-petition means in this context",
      paragraphs: [
    ...
    {
      heading: "2. Who may qualify for a VAWA self-petition",
      paragraphs: [
    ...
    {
      heading: "5. What VAWA self-petitioning does and does not do",
      paragraphs: [
    ...
    {
      heading: "6. Why abuse cases need category-specific analysis",
      paragraphs: [
    ...
    {
      heading: "7. A practical checklist before relying on self-petitioning",
      paragraphs: [
  ...
  sources: [
    {
      title: "Green Card for VAWA Self-Petitioner",
      url: "https://www.uscis.gov/green-card/green-card-eligibility/green-card-for-vawa-self-petitioner",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Form I-360, Petition for Amerasian, Widow(er), or Special Immigrant",
