...
export const familyMemberPermanentResidenceFaqPost: BlogPost = {
  slug: "family-member-permanent-residence-faq",
  title: "Frequently asked questions about permanent residence through a family member",
  excerpt:
  ...
  seoDescription:
    "A FAQ-style guide to permanent residence through a family member, covering Form I-130, sponsor eligibility, immediate relatives, preference categories, the Visa Bulletin, and Affidavit of Support rules.",
  keyTakeaways: [
    "Not every family relationship qualifies for permanent residence, and the list depends on whether the sponsor is a U.S. citizen or a lawful permanent resident.",
  ...
  sections: [
    ...
    {
      heading: "1. Who can sponsor a family member for permanent residence?",
      paragraphs: [
    ...
    {
      heading: "2. Does every family relationship qualify for a green card?",
      paragraphs: [
    ...
    {
      heading: "3. What is the difference between an immediate relative and a family-preference category?",
      paragraphs: [
    ...
    {
      heading: "4. What are the family-preference categories?",
      paragraphs: [
    ...
    {
      heading: "5. What does Form I-130 actually do?",
      paragraphs: [
    ...
    {
      heading: "6. How long does the family-based green card process take?",
      paragraphs: [
      ...
      note: "If someone asks how long a family case will take, the honest answer is that category, country, and filing date all matter."
    },
    {
      heading: "7. What is a priority date, and why does it matter?",
      paragraphs: [
    ...
    {
      heading: "8. Does the sponsor need to prove financial support?",
      paragraphs: [
    ...
    {
      heading: "9. Can the family member apply inside the United States, or do they have to go abroad?",
      paragraphs: [
    ...
    {
      heading: "10. Can immediate relatives file faster than preference-category relatives?",
      paragraphs: [
    ...
    {
      heading: "11. What if the sponsoring relative is abusive?",
      paragraphs: [
    ...
    {
      heading: "12. What is the safest way to evaluate a family-based permanent residence case?",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Family of Green Card Holders (Permanent Residents)",
    ...
    },
    {
      ...
      url: "https://www.uscis.gov/green-card/green-card-processes-and-procedures/affidavit-of-support",
      publisher: "USCIS"
    },
    {
      title: "I-864, Affidavit of Support Under Section 213A of the INA",
      url: "https://www.uscis.gov/i-864",
      publisher: "USCIS"
    },
    {
      title: "Visa Availability and Priority Dates",
