...
export const usImmigrationLegalFrameworkPost: BlogPost = {
  slug: "us-immigration-legal-framework",
  ...
  seoDescription:
    "A practical guide to the U.S. immigration legal framework, including statutes, regulations, court decisions, agencies, and how nonimmigrant visa categories are organized.",
  keyTakeaways: [
    "U.S. immigration law is built from statutes passed by Congress, regulations issued by executive agencies, and court decisions interpreting both.",
    "The main executive-branch players in immigration include DHS, the Department of State, and the Department of Justice.",
    "Nonimmigrant visas are often discussed either by their letter category, such as B, F, J, K, L, or O, or by their purpose, such as visiting, studying, working temporarily, or humanitarian protection."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. The three layers people need to understand",
      paragraphs: [
    ...
    {
      heading: "3. Executive agencies turn statutes into day-to-day rules",
      paragraphs: [
      ...
      note: "This division of responsibility is one reason immigration procedures can feel fragmented."
    },
    {
      heading: "4. Regulations matter because the statute is not the whole story",
      paragraphs: [
    ...
    {
      heading: "5. Courts can reshape how immigration law works",
      paragraphs: [
    ...
    {
      heading: "8. Another useful way to think about visas is by function",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Regulations",
      url: "https://www.uscis.gov/laws-and-policy/regulations",
      publisher: "USCIS"
    },
    {
      title: "U.S. Visa Law & Policy",
    ...
    {
      title: "AILA's Immigration Lawyer Search",
    ...
    },
    {
      ...
      publisher: "Immigration Advocates Network"
    }
  ]
};
