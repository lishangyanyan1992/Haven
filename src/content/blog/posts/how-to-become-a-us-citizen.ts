...
export const howToBecomeAUsCitizenPost: BlogPost = {
  slug: "how-to-become-a-us-citizen",
  ...
  seoDescription:
    "A current 2026 guide to how U.S. citizenship works, including birthright citizenship, citizenship through parents, and naturalization requirements such as Form N-400, continuous residence, physical presence, English, civics, and the oath.",
  keyTakeaways: [
    "Most people become U.S. citizens through birth in the United States, through U.S. citizen parents, or through naturalization.",
    "Citizenship through parents is fact-specific and depends on the law in effect at the time of birth or before the child turns 18.",
    "Naturalization usually requires lawful permanent residence, continuous residence, physical presence, good moral character, English and civics, and an oath of allegiance."
  ],
  faqs: [
    {
      question: "What are the main ways to become a U.S. citizen?",
      answer:
    ...
    {
      question: "If one parent is a U.S. citizen, is the child automatically a U.S. citizen?",
      answer:
    ...
    {
      question: "How long do you need a green card before applying for naturalization?",
      answer:
    ...
    {
      question: "Is five years as a green card holder enough by itself to naturalize?",
      answer:
  ...
  sections: [
    ...
    {
      heading: "1. Citizenship by birth in the United States",
      paragraphs: [
    ...
    {
      heading: "2. Citizenship through U.S. citizen parents",
      paragraphs: [
      ...
      note: "For children born abroad, the governing statute can change depending on the date of birth, so the correct rule is highly time-specific."
    },
    {
      heading: "3. Automatic citizenship after birth before age 18",
      paragraphs: [
    ...
    {
      heading: "4. Naturalization is the main adult path",
      paragraphs: [
    ...
    {
      heading: "5. The core naturalization requirements most people miss",
      paragraphs: [
    ...
    {
      heading: "6. Continuous residence and physical presence are different rules",
      paragraphs: [
    ...
    {
      heading: "7. Good moral character is broader than having no criminal record",
      paragraphs: [
    ...
    {
      heading: "8. English, civics, and disability exceptions",
      paragraphs: [
    ...
    {
      heading: "9. Filing early, interview, and oath",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Chapter 2 - Becoming a U.S. Citizen",
      url: "https://www.uscis.gov/policy-manual/volume-12-part-a-chapter-2",
      publisher: "USCIS Policy Manual"
    },
    {
      title: "I am the Child of a U.S. Citizen",
      url: "https://www.uscis.gov/citizenship/learn-about-citizenship/i-am-the-child-of-a-us-citizen",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Exceptions and Accommodations",
      url: "https://www.uscis.gov/citizenship/exceptions-and-accommodations",
      publisher: "USCIS"
    },
    {
      title: "Green Card for a Person Born in the United States to a Foreign Diplomat",
      url: "https://www.uscis.gov/green-card/green-card-eligibility/green-card-for-a-person-born-in-the-united-states-to-a-foreign-diplomat",
      publisher: "USCIS"
    }
  ]
};
