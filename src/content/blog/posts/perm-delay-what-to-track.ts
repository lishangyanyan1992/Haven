...
export const permDelayWhatToTrackPost: BlogPost = {
  slug: "perm-delay-what-to-track",
  ...
  keyTakeaways: [
    "Not every delay changes your legal options, but some delays change your planning horizon.",
    "Ask where the case is stuck instead of accepting a generic 'still pending' update.",
    "Your H-1B extension strategy and your green card timeline should be reviewed together."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Know which stage is delayed",
      paragraphs: [
    ...
    {
      heading: "2. Track whether your H-1B clock is affected",
      paragraphs: [
    ...
    {
      heading: "3. Separate internal employer delay from government delay",
      paragraphs: [
    ...
    {
      heading: "4. Re-check your backup options before you need them",
      paragraphs: [
