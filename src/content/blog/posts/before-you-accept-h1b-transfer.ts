...
export const beforeYouAcceptH1bTransferPost: BlogPost = {
  slug: "before-you-accept-h1b-transfer",
  ...
  keyTakeaways: [
    "Ask when the transfer will be filed, not just when you are expected to start.",
    "Work location and role details matter as much as compensation.",
    "A transfer can affect your green card strategy even when short-term work authorization looks fine."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Ask about filing timing, not just start date",
      paragraphs: [
    ...
    {
      heading: "2. Verify role, location, and reporting structure",
      paragraphs: [
    ...
    {
      heading: "3. Review how the move affects the green card path",
      paragraphs: [
    ...
    {
      heading: "4. Write down your backup branch anyway",
      paragraphs: [
