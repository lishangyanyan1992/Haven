...
export const publicChargeFraudAndDocumentationInadmissibilityPost: BlogPost = {
  slug: "public-charge-fraud-and-documentation-inadmissibility",
  ...
  seoDescription:
    "A current 2026 guide to four commonly confused inadmissibility grounds: public charge, labor certification and immigrant qualifications, fraud or willful misrepresentation, and documentation problems.",
  keyTakeaways: [
    "Public charge is its own inadmissibility ground, and it does not apply to every immigrant or nonimmigrant case.",
    "The labor-certification ground is not a general rule that anyone planning to work without permission is automatically inadmissible under INA 212(a)(5). It is mainly about certain employment-based immigrant cases and a few labor-related nonimmigrant categories.",
    "Fraud, willful misrepresentation, false claims to U.S. citizenship, and missing travel documents are related in practice but legally distinct problems with different waiver and consequence rules."
  ],
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: "1. Public charge: narrower than most people think",
      paragraphs: [
      ...
      note: "State Department guidance for visa cases and USCIS guidance for adjustment cases are aligned around the narrower post-2022 framework, not the broader 2019-era approach."
    },
    {
      heading: "2. Labor certification and immigrant qualifications: what this ground really covers",
      paragraphs: [
    ...
    {
      heading: "3. Fraud and willful misrepresentation are not the same as missing paperwork",
      paragraphs: [
    ...
    {
      heading: "4. False claim to U.S. citizenship is a separate and more dangerous problem",
      paragraphs: [
      ...
      note: "This is one of the areas where the exact facts, date, and purpose of the claim matter enormously."
    },
    {
      heading: "5. Documentation problems: a different ground again",
      paragraphs: [
    ...
    {
      heading: "6. Why stowaways, smugglers, and immigration violators should be analyzed separately",
      paragraphs: [
    ...
    {
      heading: "7. Who makes these determinations",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Chapter 9 - Adjudicating Public Charge Inadmissibility for Adjustment of Status Applications",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-g-chapter-9",
      publisher: "USCIS"
    },
    {
      title: "Final Rule Governing Public Charge Grounds of Visa Ineligibility",
      url: "https://travel.state.gov/content/travel/en/News/visas-news/final-rule-governing-public-charge-grounds-of-visa-ineligibility.html",
    ...
    {
      title: "Chapter 6 - Permanent Labor Certification",
      url: "https://www.uscis.gov/policy-manual/volume-6-part-e-chapter-6",
      publisher: "USCIS"
    },
    {
    ...
    {
      title: "Chapter 2 - Overview of Fraud and Willful Misrepresentation",
      url: "https://www.uscis.gov/policy-manual/volume-8-part-j-chapter-2",
      publisher: "USCIS"
    },
    {
      title: "Chapter 3 - Adjudicating Inadmissibility",
  ...
  faqs: [
    {
      question: "Is public charge the same as not having enough money?",
      answer:
    ...
    {
      question: "Does the labor-certification inadmissibility ground apply to anyone who wants to work in the U.S.?",
      answer:
    ...
    {
      question: "Is using fake documents the same as fraud?",
      answer:
    ...
    {
      question: "Why is a false claim to U.S. citizenship treated differently from ordinary misrepresentation?",
      answer:
