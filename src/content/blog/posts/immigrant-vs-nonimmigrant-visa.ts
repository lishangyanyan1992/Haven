...
export const immigrantVsNonimmigrantVisaPost: BlogPost = {
  slug: "immigrant-vs-nonimmigrant-visa",
  ...
  seoDescription:
    "A practical guide to the difference between immigrant and nonimmigrant visas, including temporary intent, green cards, dual intent, and why 214(b) denials happen.",
  keyTakeaways: [
    "An immigrant visa is for someone who plans to live in the United States permanently; a nonimmigrant visa is for a temporary, specific purpose.",
  ...
  sections: [
    ...
    {
      heading: "1. What an immigrant visa means",
      paragraphs: [
    ...
    {
      heading: "2. What a nonimmigrant visa means",
      paragraphs: [
    ...
    {
      heading: "3. The real difference is not just paperwork, but intent",
      paragraphs: [
    ...
    {
      heading: "4. Why 214(b) matters for nonimmigrant visas",
      paragraphs: [
      ...
      note: "This is one reason the difference between immigrant and nonimmigrant visas matters so much in practice, not just in theory."
    },
    {
      heading: "5. Dual intent is the exception people should understand",
      paragraphs: [
    ...
    {
      heading: "6. A few categories blur the line",
      paragraphs: [
    ...
    {
      heading: "7. Can a nonimmigrant become a permanent resident later?",
      paragraphs: [
    ...
    {
      heading: "8. A practical way to think about the distinction",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Dual Intent Visa Explained: Navigating Nonimmigrant Intent and Your Path to a Green Card",
      url: "https://citizenpath.com/faq/immigrant-nonimmigrant-visa/",
      publisher: "CitizenPath"
    }
  ]
};
