...
export const familyAndSelfSponsorshipPermanentResidencyPost: BlogPost = {
  ...
  sections: [
    ...
    {
      heading: "1. The first split: immediate relatives vs family-preference categories",
      paragraphs: [
    ...
    {
      heading: "4. Why the Visa Bulletin matters so much",
      paragraphs: [
    ...
    {
      heading: "5. What happens after the petition is approved",
      paragraphs: [
