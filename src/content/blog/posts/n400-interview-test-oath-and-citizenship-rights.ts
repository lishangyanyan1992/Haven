...
export const n400InterviewTestOathAndCitizenshipRightsPost: BlogPost = {
  slug: "n400-interview-test-oath-and-citizenship-rights",
  ...
  seoDescription:
    "A current 2026 guide to what happens after filing Form N-400, including the naturalization interview, English and civics test, N-648 disability exceptions, 50/20 and 55/15 language exceptions, the oath ceremony, N-336 after denial, and the rights and responsibilities of U.S. citizenship.",
  keyTakeaways: [
    "After filing N-400, most applicants go through biometrics handling, an interview, English and civics testing unless exempt, and an oath ceremony if approved.",
    "Age-based and disability-based exceptions are real, but they work under specific USCIS rules and do not eliminate every part of the naturalization process.",
    "Approval does not make someone a U.S. citizen until the oath is properly completed, and a denial can sometimes be challenged through Form N-336."
  ],
  faqs: [
    {
      question: "What happens after I submit Form N-400?",
      answer:
    ...
    {
      question: "Can I skip the English and civics test because of a medical condition?",
      answer:
    ...
    {
      question: "Do the 50/20 and 55/15 rules waive the civics test too?",
      answer:
    ...
    {
      question: "If USCIS denies my naturalization case, can I challenge the decision?",
      answer:
        "Sometimes yes. USCIS uses Form N-336 to request a hearing on a denied Form N-400, and the timing rules are strict."
    }
  ],
  relatedSlugs: [
    "who-can-file-n400-naturalization-eligibility",
  ...
  sections: [
    ...
    {
      heading: "1. What USCIS does after you file N-400",
      paragraphs: [
    ...
    {
      heading: "2. The naturalization interview has two main parts",
      paragraphs: [
    ...
    {
      heading: "3. The test changed for recent filings",
      paragraphs: [
    ...
    {
      heading: "4. What the English and civics test looks like",
      paragraphs: [
      ...
      note: "In practice, if you fail part of the test at the first interview, USCIS usually schedules a second chance on the part you failed between 60 and 90 days later."
    },
    {
      heading: "5. Medical disability exception through Form N-648",
      paragraphs: [
    ...
    {
      heading: "6. Age-based exceptions: 50/20, 55/15, and 65/20",
      paragraphs: [
    ...
    {
      heading: "7. 65/20 special consideration still matters",
      paragraphs: [
    ...
    {
      heading: "8. Approval, oath, and certificate",
      paragraphs: [
    ...
    {
      heading: "9. If the application is denied",
      paragraphs: [
      ...
      note: "Some applicants may also choose to refile later instead of pursuing an N-336 hearing, depending on the reason for denial."
    },
    {
      heading: "10. Processing times depend on where the case is handled",
      paragraphs: [
    ...
    {
      heading: "11. Rights and responsibilities after naturalization",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Medical Certification for Disability Exceptions (Form N-648)",
      url: "https://www.uscis.gov/n-648",
      publisher: "USCIS"
    },
    {
      title: "USCIS Policy Manual: Medical Disability Exception",
      url: "https://www.uscis.gov/policy-manual/volume-12-part-e-chapter-3",
    ...
    {
      title: "Naturalization Oath of Allegiance to the United States of America",
    ...
    {
      title: "Request for a Hearing on a Decision in Naturalization Proceedings (Form N-336)",
      url: "https://www.uscis.gov/n-336",
      publisher: "USCIS"
    },
    {
      title: "Should I Consider U.S. Citizenship?",
      url: "https://www.uscis.gov/citizenship/learn-about-citizenship/should-i-consider-us-citizenship",
      publisher: "USCIS"
    },
    {
      title: "Check Case Processing Times",
